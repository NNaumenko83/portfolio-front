...
const Card = ({
    ...
    return (
        <div
            ...
            className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative lg:h-[35rem] rounded-3xl overflow-hidden"
        >
            ...
            <div className="relative z-20">
                ...
                <h2 className="text-sm dark:text-white opacity-0 group-hover/canvas-card:opacity-100 relative z-10 text-black mt-2 group-hover/canvas-card:text-white transition duration-200 text-center" style={{ color: "#e4ecff" }}>
                    {des}
                </h2>
